...
My initial conernw as right! As per the instructor solution there was one key thing I did wrong... I should not have managed the show form state within ExpenseForm but rather within NewExpense. Expense form is component concern wiith sut the form....whether we display the form or not should be managed int he NewExpense overall componet. So our answer was correct but not elegant... see here for the refactor ([commit](https://github.com/rl627/udemy-react-js-academind/commit/8f9a3696d8d70d38e14b821f21b83414a206dd77)).
...
Next lets get make the individual bars; we used dynamic stlying to contorl how much of the bar (via height) is filled

🦀 Style attirbutes work differently when buidling a React componet; style wants an object; the dynamic JS styling is a object. We use {{ }}. Note for css properties that have a dash just use camel case🦀

Here is the final ChartBar compoennt which calculated the bar height from the passed in value and max value then returns a JSX snippet with dynamic styling for height.
...
We then add the ExpenseChart component to our Expenses Component; adding appropraite imports and it should work! ([commit](https://github.com/rl627/udemy-react-js-academind/commit/1dee3528c89ac31be1962e606d8e56e27b0e74b4))
...
the 'Design' section describes how I will organize my component tree (how many modules, which will be stateful and which will be controlled...ETC).
